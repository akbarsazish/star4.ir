    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    ...
                    <button type="button" class="close btn bg-danger" data-BS-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark fa-xl"></i>
                    </button>
                </div>
...
<div class="modal fade dragAbleModal" id="goodSalesRound" data-bs-backdrop="static"  tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" style="font-size: 20px; font-weight:bold;"> گردش فروش <span id="kalaNameRound"></span></h5>
                    <button type="button" class="close btn bg-danger" data-BS-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark fa-xl"></i>
                    </button>
                </div>
                <div class="modal-body">
