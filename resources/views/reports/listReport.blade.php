               ...
               <div class="col-lg-2 col-md-2 col-sm-3 sideBar">
                ...
                <div class="col-sm-10 col-md-10 col-sm-12 contentDiv">
                    ...
                    <div class="row mainContent">
                        <div class="col-sm-12" style="display:none" id="customerLocationDiv">
                            <div id="map"></div>
                        </div>
