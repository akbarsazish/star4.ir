                ...
                <fieldset class="border rounded mt-5 sidefieldSet">
                    ...
                    @if(hasPermission(Session::get("asn"),"AddOppupDownBonusN") > -1)
                        ...
                        <div class="col-lg-12" style="margin-top:40vh">
                            ...
                            <button type="button" class="btn d-block w-50 btn-primary btn-sm" disabled id="editCreditBtn"> اصلاح <i class="fa fa-edit"></i> </button>
                            @endif
                            @if(hasPermission(Session::get("asn"),"AddOppupDownBonusN") > 1 or hasPermission(Session::get("asn"),"SubOppupDownBonusN") > 1)
                            <button type="button" class="btn d-block w-50 btn-danger btn-sm" disabled id="deleteCreditBtn"> حذف <i class="fa fa-trash"></i>  </button>
                            @endif
                        </div>
                </fieldset>
            </div>
                            ...
                            <tbody class="tableBody" id="historyListBody">
                                @foreach ($admins as $admin)
                                    <tr onclick="setUpDownHistoryStuff(this,{{$admin->historyId}})">
                                        ...
                                        <td  style="width:144px">{{trim($admin->superName)}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
            ...
            <form action="{{url('/addUpDownBonus')}}" id="addingEmtyaz" method="get">
                    @csrf
                        ...
                        <div class="row mt-2">
                            ...
                            <textarea class="form-control" rows="3" id="comment" name="discription" required></textarea>
                        </div>
                    </div>
      ...
      <div class="modal-body">
            <form action="{{url('/editUpDownBonus')}}" id="editEmtyaz" method="get">
                    @csrf
                        ...
                        <div class="row mt-2">
                            <label for="comment">توضیحات </label>
                            <textarea class="form-control" rows="3" id="commentBonus" name="discription" required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal">بستن <i class="fa fa-xmark"> </i></button>
