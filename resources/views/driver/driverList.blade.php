                            ...
                            <table class="table table-bordered crmDataTable driverTable" id="tableGroupList">
                                <thead class="bg-primary tableHeader">
                                    <tr>
                                        ...
                                        <th>تلفن </th>
                                        <th style="width:50px"> <i class="fas fa-map-marker-alt fa-1xl" style="color:#fff"></i>  </th>
                                        <th style="width:50px">فاکتور</th>
                                        <th style="width:55px" > تحویل </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody class="c-checkout tableBody" id="crmDriverBargeri">
                                    @foreach ($factors as $factor)
                                        <tr onclick="setBargiryStuff(this,{{$factor->PSN}})" id="givfactors" @if($factor->isGeven==1) class="selected" @endif>
                                            <td style="width:40px !important;">{{$loop->iteration}}</td>
                                            ...
                                            <td style="width:50px; text-align: center;"><a style="text-decoration:none;" target="_blank" href="geo:{{$factor->LonPers.','.$factor->LatPers}}"><i class="fas fa-map-marker-alt fa-1xl" style="color:#116bc7;"></i></a></td>
                    ...
                    <table id="strCusDataTable"  class='css-serial display table table-bordered table-striped table-sm' style="background-color:#dee2e6">
                        <thead class="bg-primary">
                            <tr>
                                ...
                                <th>فی (تومان)</th>
                                <th style="width:90px">مبلغ (تومان)</th>
