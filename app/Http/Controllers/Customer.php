...
class Customer extends Controller
{
    ...
    public function getAdminEmptyState(Request $request)
    {
       ...
       return Response::json($admin[0]->emptyState);
    }
    ...
    public function filterNewCustomers(Request $request){
        ...
        $boughtState=$request->get("boughtState");
        $customers=DB::select("exec CRM.dbo.filterNewCustomers '$adminName',$boughtState");
        return Response::json($customers);
    }
...
public function getTakhsisEditRightSide(Request $request)
{
    ...
    AND CompanyNo=5 AND IsActive=1 and SaleLevel=3 AND Name LIKE N'%$name%' AND SnMantagheh LIKE '%$mantagheh%' ".$queryBuyDatePart." ".$querySabtDatePart."");
    return Response::json($customers);
}
