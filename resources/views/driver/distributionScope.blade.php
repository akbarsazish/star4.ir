...
@section('content')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 ">
                                ...
                                <label for="" class="form-label mb-0">    </label>
                                     <i id="addingShowBtn" class="fa fa-circle-plus fa-lg" style="font-size:33px; color:blue; margin-top:33px; cursor:pointer"></i>
                                </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2"> 
                            <div class="col-lg-12 text-center">
                                <button type="submit" class="btn btn-sm btn-primary"> تعیین موقعیت مکانی  <i class="fa fa-map-marker "></i> </button>
                            </div>
                         </div>
                    </div>
  ...
  <!-- modal for  showing city -->
      <div class="modal fade dragableModal" id="showCity"  tabindex="-1"   data-bs-backdrop="static" >
            <div class="modal-dialog modal-dialog-scrollable  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header py-2 text-white">
                           <button type="button" class="btn-close bg-danger" data-bs-dismiss="modal" aria-label="Close"></button>
                         <h5 class="modal-title" id="exampleModalLabel"> نمایش شهرها  </h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                             ...
                             <div class="col-lg-6">
                                <label for="exampleInputEmail1 mb-0" class="form-label"> جستجو  </label>
                                <input type="text" class="form-control form-control-sm" name="" aria-describedby="emailHelp">
                            </div>
                        </div>
                        <table class="select-highlight table table-bordered table-striped table-sm" id="">
                            <thead class="tableHeader">
                                <tr>
                                    <th>ردیف</th>
                                    <th> استان   </th>
                                    <th> کد شهر    </th>
                                    <th style=" width:122px"> شهر  </th>
                                </tr>
                            </thead>
                            <tbody class="tableBody" style="height:155px !important" id=""> 
                                <tr>
                                    <td>1</td>
                                    <td> تهران  </td>
                                    <td> 2222 </td>
  ...
  <!-- modal for adding city -->
      <div class="modal fade dragableModal" id="addingCityModal"  tabindex="-1"   data-bs-backdrop="static" >
            <div class="modal-dialog modal-dialog-scrollable  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header py-2 text-white">
                           <button type="button" class="btn-close bg-danger" data-bs-dismiss="modal" aria-label="Close"></button>
                         <h5 class="modal-title" id="exampleModalLabel"> تعریف شهرها  </h5>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
