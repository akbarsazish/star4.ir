            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="totalEmteyaz-container">
                        ...
                        @else
                            <div class="totalEmteyaz-item">تعداد سرویس دور: {{$driverBonusInfo["all_Strong_Service"]}}  </div>
                            <div class="totalEmteyaz-item">تعداد سرویس متوسط: {{$driverBonusInfo["all_Medium_Service"]}}  </div>
                            <div class="totalEmteyaz-item">تعداد سرویس نزدیک: {{$driverBonusInfo["count_all_WeakService"]}} </div>  
                            <div class="totalEmteyaz-item">تعداد اقلام: {{$driverBonusInfo["count_All_aghlam"]}} </div>
                            <div class="totalEmteyaz-item">تعداد فاکتور: {{$driverBonusInfo["count_all_Factor"]}} </div>
                            <div class="totalEmteyaz-item">تارگت اقلام: {{$driverBonusInfo["aghlamComTg"]}}</div> 
                            <div class="totalEmteyaz-item">تارگت فاکتور ها:  {{$driverBonusInfo["countFactorComTg"]}} </div>
                            <div class="totalEmteyaz-item">تارگت سرویس دور: {{$driverBonusInfo["strongServiceComTg"]}}</div>  
                            <div class="totalEmteyaz-item">تارگت سروریس متوسط: {{$driverBonusInfo["mediumServiceComTg"]}}</div>  
                            <div class="totalEmteyaz-item">تارگت سرویس نزدیک: {{$driverBonusInfo["weakServiceComTg"]}}</div>

                            <div class="totalEmteyaz-item">امتیاز سرویس دور: {{$driverBonusInfo["all_Strong_Service_Bonus"]}}  </div>
                            <div class="totalEmteyaz-item">امتیاز سرویس متوسط: {{$driverBonusInfo["all_Medium_Service_Bonus"]}}  </div>
                            <div class="totalEmteyaz-item">امتیاز سرویس نزدیک: {{$driverBonusInfo["all_Weak_Service_Bonus"]}} </div>  
                            <div class="totalEmteyaz-item">امتیاز اقلام: {{$driverBonusInfo["bonus_All_aghlam"]}} </div>
                            <div class="totalEmteyaz-item">امتیاز فاکتور: {{$driverBonusInfo["count_all_Factor_Bonus"]}} </div>
                            <div class="totalEmteyaz-item"> امتیاز تارگت اقلام: {{$driverBonusInfo["aghlamComTgBonus"]}}</div> 
                            <div class="totalEmteyaz-item">امتیاز تارگت فاکتور ها:  {{$driverBonusInfo["countFactorComTgBonus"]}} </div>
                            <div class="totalEmteyaz-item">امتیاز تارگت سرویس دور: {{$driverBonusInfo["strongServiceComTgBonus"]}}</div>  
                            <div class="totalEmteyaz-item">امتیاز تارگت سروریس متوسط : {{$driverBonusInfo["mediumServiceComTgBonus"]}}</div>  
                            <div class="totalEmteyaz-item">امتیاز تارگت سرویس نزدیک: {{$driverBonusInfo["weakServiceComTgBonus"]}}</div>
                            <div class="totalEmteyaz-item bg-info">مجموع کل امتیازات :{{$driverBonusInfo["all_bonus_since_Empty"]}}</div>
                        @endif
                    </div>
             </div>
       </div>
